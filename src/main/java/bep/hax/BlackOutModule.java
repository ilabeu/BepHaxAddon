...
import bep.hax.util.PriorityUtils;
...
import bep.hax.mixin.ClientWorldAccessor;
...
public class BlackOutModule extends Module {
    ...
    public void sendSequenced(SequencedPacketCreator packetCreator) {
        ...
        PendingUpdateManager sequence = ((ClientWorldAccessor) mc.world).invokeGetPendingUpdateManager().incrementSequence();
