...
import bep.hax.util.*;
import bep.hax.util.RaksuTone.RaksuPath;
import bep.hax.util.RaksuTone.RaksuTone;
...
public class AutoPvp extends BlackOutModule {
    public AutoPvp() {
        super(Bep.BLACKOUT, "Auto CC", "Follows people using baritone. Best for crystalpvp.cc");
    }
