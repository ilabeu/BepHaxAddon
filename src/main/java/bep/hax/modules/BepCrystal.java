...
public class BepCrystal extends Module {
    ...
    public void onRender3D(Render3DEvent event) {
        if (render.get() && renderPos != null && targetInfo != null) {
            ...
            //RenderManager.renderFilledBox(event.getMatrices(), renderBox, fill.get().getRGB());
            //RenderManager.renderBoundingBox(event.getMatrices(), renderBox, 1.5f, line.get().getRGB());
            ...
            if (damageRender.get() && targetInfo != null) {
                ...
                NametagUtils.end();
                //event.renderer.renderText(event.getMatrices(), String.format("%.1f", targetInfo.damage()), lerpRenderPos.x, lerpRenderPos.y - 0.25, lerpRenderPos.z, 0.03f, false, java.awt.Color.WHITE);
            }
    ...
    public void breakCrystal(EndCrystalEntity crystal) {
        ...
        //if (targetInfo != null && targetInfo.pos.up().equals(crystal.getBlockPos()))
        //placeCrystal(crystal.getBlockPos().down());
    ...
    public void placeCrystalForTarget(PlayerEntity target, BlockPos blockPos) {
        ...
        RotationUtils.getInstance().setRotation(new RotationUtils.Rotation(100, rotations[0], rotations[1]));
