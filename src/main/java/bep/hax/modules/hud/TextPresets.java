...
public class TextPresets {
    public static final HudElementInfo<TextHud> INFO = new HudElementInfo<>(Bep.HUD_GROUP, "higtools-presets", "Displays text with Starscript.", TextPresets::create);
    ...
    static {
        ...
        addPreset("Welcome Hud", "HIG, #1{meteor.is_module_active(\"name-protect\") ?  meteor.get_module_setting(\"name-protect\", \"name\") : player._toString}", 0);
    }
