...
import bep.hax.Bep;
import bep.hax.util.ChunkUtils;
import bep.hax.util.LogUtils;
import bep.hax.util.TimerUtils;
...
public class DubCounter extends Module {
    ...
    public DubCounter() {
        super(Bep.CATEGORY, "dub-counter", "Counts how many double chests are in render distance.by IKEA ADDON");
    }
