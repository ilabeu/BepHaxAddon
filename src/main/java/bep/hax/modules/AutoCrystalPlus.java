...
import bep.hax.enums.RotationType;
import bep.hax.enums.SwingHand;
import bep.hax.enums.SwingState;
import bep.hax.enums.SwingType;
import bep.hax.managers.Managers;
import bep.hax.mixin.IInteractEntityC2SPacket;
import bep.hax.timers.TimerList;
import bep.hax.util.BOInvUtils;
import bep.hax.util.ExtrapolationUtils;
import bep.hax.util.OLEPOSSUtils;
import bep.hax.util.SettingUtils;
import bep.hax.util.meteor.BODamageUtils;
import bep.hax.util.meteor.BOEntityUtils;
...
public class AutoCrystalPlus extends BlackOutModule {
    public AutoCrystalPlus() {
        super(Bep.BLACKOUT, "Auto Crystal+", "Breaks and places crystals automatically (but better).");
    }
